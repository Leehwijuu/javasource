...
public class OperEx5 {
    public static void main(String[] args) {
        ...
        // 대문자로 시작하면 가바에서는 객체의 의미가 있음(객체 상태일 때 할 수 있는 것이 많다)

        // 자바에서 문자열 생성하는 다양한 방법 때문에 저장되는 위치가 조금 다를 수 있음
        // 문자역의 비교는 == 을 사용하지 않음(결과가 달라질 수 있기 때문에)
        String str1 = "이휘주", str2 = "이휘주";
        String str3 = new String("이휘주");
